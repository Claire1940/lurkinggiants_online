...
const BASE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.lurkinggiants.online'

// 内容类型优先级配置（key 必须与 navigation.ts 的 NAVIGATION_CONFIG 一致）
...
// 内容更新频率配置（key 必须与 navigation.ts 的 NAVIGATION_CONFIG 一致）
