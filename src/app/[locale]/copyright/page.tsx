...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Lurking Giants Wiki',
    description: 'Copyright and intellectual property information for Lurking Giants Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Lurking Giants Wiki',
      description: 'Copyright and intellectual property information for Lurking Giants Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Lurking Giants Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Lurking Giants Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Lurking Giants Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox</strong> - Owner of the Roblox platform</li>
              <li><strong>Lurking Giants Developers</strong> - Creators of the Lurking Giants game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>ROBLOX</strong> - Trademark of ULTRA works</li>
              <li><strong>Lurking Giants</strong> - Trademark of the game developers</li>
              <li><strong>Lurking Giants Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Lurking Giants Wiki.
            </p>
            ...
            <p>
              ...
              Lurking Giants Wiki<br />
              Email: <a href="mailto:dmca@lurkinggiants.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lurkinggiants.online</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Lurking Giants Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Lurking Giants Wiki (lurkinggiants.online)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@lurkinggiants.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@lurkinggiants.online</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@lurkinggiants.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@lurkinggiants.online</a>
            </p>
            <p>
