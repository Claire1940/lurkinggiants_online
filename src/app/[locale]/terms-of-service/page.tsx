...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Lurking Giants Wiki",
    description: "Read the Terms of Service for Lurking Giants Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Lurking Giants Wiki",
      description: "Terms and conditions for using Lurking Giants Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Lurking Giants Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Lurking Giants Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Lurking Giants Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Lurking Giants Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game "Lurking Giants". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and survival strategies</li>
              <li>Active codes, rewards, and redemption steps</li>
              <li>Giant guides and tier lists</li>
              <li>Map layouts and best hiding spots</li>
              <li>Perk combos and advanced movement</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Lurking Giants Wiki is NOT affiliated with, endorsed by, or associated with
              ULTRA works (Roblox) or the official developers of Lurking Giants. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Lurking Giants Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of ULTRA works (Roblox) and/or the developers of Lurking Giants. We use such
            ...
            <ul>
              ...
              <li><strong>Game Updates:</strong> Roblox game content, codes, and balance updates may change without notice. We are not responsible for game changes or access issues.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, LURKING GIANTS WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Lurking Giants Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@lurkinggiants.online" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@lurkinggiants.online</a>
            </p>
            <p>
